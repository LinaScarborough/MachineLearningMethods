...
This section loads the dataset from the provided URL and displays a summary of the data, providing an overview of its structure and contents.
...
1. **StichtagDatJahr**: Year of the data record.
2. **HalterId**: Unique identifier for the pet owner.
3. **AlterV10Cd, AlterV10Lang, AlterV10Sort**: Codes, descriptions, and sorting for the age group of the pet owner.
4. **SexCd, SexLang, SexSort**: Codes, descriptions, and sorting for the gender of the pet owner.
5. **KreisCd, KreisLang, KreisSort**: Codes, descriptions, and sorting for the district.
6. **QuarCd, QuarLang, QuarSort**: Codes, descriptions, and sorting for the quarter.
7. **Rasse1Text, Rasse2Text**: Primary and secondary breed descriptions of the pet.
8. **RasseMischlingCd, RasseMischlingLang, RasseMischlingSort**: Codes, descriptions, and sorting for whether the pet is a mixed breed.
9. **RassentypCd, RassentypLang, RassentypSort**: Codes, descriptions, and sorting for the type of breed.
10. **GebDatHundJahr**: Year of birth of the pet.
11. **AlterVHundCd, AlterVHundLang, AlterVHundSort**: Codes, descriptions, and sorting for the age group of the pet.
12. **SexHundCd, SexHundLang, SexHundSort**: Codes, descriptions, and sorting for the gender of the pet.
13. **HundefarbeText**: Color of the pet.
14. **AnzHunde**: Number of dogs.


# 3. Translation

In this section, English translations for the column names are defined, and a function is employed to replace multiple patterns at once for content translation. This includes translations for age groups, sexes, breed types, and dog colors. After applying the translation function across all relevant columns, dog colors are also translated.
...
This step involves identifying and marking the initial occurrence of each OwnerId as unique within the dataset. This distinction facilitates further analyses that may require the identification of distinct entries.
...
```{r unique_OwnerId, include=FALSE}
...
## 6.2. Unique owners by age group over years
...
# Define UI
ui <- fluidPage(
  titlePanel("Dog Population Analysis"),
  sidebarLayout(
    sidebarPanel(
      helpText("Click on a year in the bar plot to see the percentage change in dog population."),
...
# 8. Heatmap of total number of dogs per year 
...
# 8. Total Count of Dogs

## 8.1. Total Count of Dogs by District
...
## 8.2. Total Count of Dogs by District with Dogs'gender
...
## 8.3. By district and Unique Owners' gender
...
## 8.4. By district and Breed Type
...
## 8.5. By district, Breed Type and Dogs's Gender
...
## 9.2. Top dog breeds by district
