...
```{r neuralnetwork, include=FALSE, cache=TRUE, cache.rebuild=FALSE}
...
```{r neuralnetwork_plots, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all'}
