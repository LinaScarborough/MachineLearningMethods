...
```{r neuralnetwork_sampling, include=FALSE, cache=TRUE, cache.rebuild=FALSE}
...
``` {r neuralnetwork_train, include=FALSE, cache=TRUE}
...
```{r neuralnetwork_plots, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', cache=TRUE, fig.align='center'}
...
```{r neuralnetwork_ROC, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.align='center', include=TRUE, cache=TRUE}
