    ...
    sidebarLayout(
        sidebarPanel(
            selectInput("selectedYear", "Select Year:", 
                        choices = unique(df_EN_EDA01$KeyDateYear)),
...
server <- function(input, output) {
    output$genderPlot <- renderPlot({
        ...
        if (input$selectedGender == "all") {
            ...
            unique_owner_counts_gender <- df_EN_EDA01 %>%
        ...
        unique_owner_counts_gender$OwnerAgeGroup <- factor(unique_owner_counts_gender$OwnerAgeGroup,
                                                           levels = unique(df_EN_EDA01$OwnerAgeGroup[order(df_EN_EDA01$OwnerAgeGroup)]))
...
Further analysis may be needed here. Although the hypothesis was to offer products tailored to the dog's age and gender, and while age appears to influence sex likelihood, additional factors such as breed and size would provide a more sound business decision making.
...
``` {r svm_linear_confusion, include=FALSE}
