...
``` {r neuralnetwork_plot, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.keep='all', cache=TRUE, fig.align='center'}
...
```{r neuralnetwork_conf_plot, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.align='center'}
