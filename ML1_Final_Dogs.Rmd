...
As mentioned above, the main data has been sourced from the [@stadtzuerich2024hundebestande], having been collected and published by the Open Data Portal of the City Council of Zürich, under the name "Hundebestände der Stadt Zürich, seit 2015". The description of the data set from the original source is as follows:
...
**String values**:
  ...
  - `BreedTypeLong`: referring to the official dog type classification according to the [@zh2009hundeverordnung]
...
For the second part of the Generalized Additive Model chapter we again direct our attention to the previously introduced research question: _how do dog counts evolve over time?_
