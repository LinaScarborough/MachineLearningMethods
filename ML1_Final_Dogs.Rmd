...
server <- function(input, output) {
    output$SexPlot <- renderPlot({
        ...
        gradient_colors <- colorRampPalette(c("aquamarine2", "darkslategray4"))(length(levels(unique_owner_counts_Sex$OwnerAgeGroup)))
...
# Define gradient colors for discrete levels
gradient_colors <- colorRampPalette(c("aquamarine2", "darkslategray4"))(length(levels(unique_owner_counts$OwnerAgeGroup)))
